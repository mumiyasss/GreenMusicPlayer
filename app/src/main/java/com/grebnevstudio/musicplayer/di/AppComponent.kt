...
import com.grebnevstudio.musicplayer.viewmodel.GlobalViewModel
...
interface AppComponent {
    ...
    fun injectGlobalViewModel(viewModel: GlobalViewModel)
    fun injectPlaylistViewModel(viewModel: PlaylistViewModel)
